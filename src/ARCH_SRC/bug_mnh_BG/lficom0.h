...
C
      PARAMETER ( JPNCPN=16, JPLARD=LFI_RECL, JPNPDF=20, JPXUFM=100 )
      PARAMETER ( JPNXFI=300, JPFACX=1, JPNPIA=4, JPNXPR=100 )
CJUANZ      PARAMETER ( JPNXFI=300, JPFACX=120, JPNPIA=4, JPNXPR=100 )
C
