...
!++++++++++++++++++++++++++++++++++++
!
  REAL              :: XT4DIFF ! Damping time scale for 2*dx wavelength
                                  ! specified for the 4nd order num. diffusion
  REAL              :: XDK2    ! 2nd order num. diffusion coef. /dx2
  REAL              :: XDK4    ! 4nd order num. diffusion coef. /dx4
!
END TYPE DYN_t
...
REAL, POINTER :: XT4DIFF=>NULL()
REAL, POINTER :: XDK2=>NULL()
REAL, POINTER :: XDK4=>NULL()
...
XT4DIFF=>DYN_MODEL(KTO)%XT4DIFF
XDK2=>DYN_MODEL(KTO)%XDK2
XDK4=>DYN_MODEL(KTO)%XDK4
